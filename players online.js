(function() {
    ...
    const titanList = [
        {level: 57, name: "Orla/Kic"}, {level: 65, name: "Kic"}, {level: 83, name: "Kic"}, {level: 88, name: "Rene"},
...
<div style="margin-bottom: 15px;">
            ...
            <div style="display: flex; gap: 5px; align-items: center;">
                <input type="text" id="github-url-input" 
                    ...
                    value="https://raw.githubusercontent.com/krystianasaaa/margonem-addons/refs/heads/main/guilds/guilds.json"
...
dialog.querySelector('#load-github-btn').onclick = async () => {
    ...
    // Użyj domyślnego URL
    const defaultUrl = 'https://raw.githubusercontent.com/krystianasaaa/margonem-addons/refs/heads/main/guilds/guilds.json';
