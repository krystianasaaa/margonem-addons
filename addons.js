...
const allowedUsers = ['6122094', '6210905', '9110806', '3543472', '4965363', '6793254', '4633387', '1661718', '7164363', '5109521', '8370413', '8228619', '7172886', '8357394', '6936569', '874973', '8144729', '1521186', '594120', '8839561', '5906841', '8824864', '2885972', '8776354', '7520102', '9269588', '7316243', '8432475', '5295667', '4664363', '9392055', '530596', '6244754', '8200643'];
if (!allowedUsers.includes(getCookie('user_id'))) return;
(function() {
    'use strict';
...
(function() {
    'use strict';
    const worldName = "dream", boxId = 'online-box', summaryBoxId = 'summary-box';
    ...
    const creatorList = ["trenbolon uderza" , "Testosteronowy Schab" , "Zemsta Schaba" , "zabujcza kwaczuszka" , "Schabixuś" , "Herx" , "Cathon"];
	const playerGuilds = {};
	let observedGuilds = [];
...
async function sendToDiscord(titanName, players) {
    ...
    const embed = {
        ...
        color: 0x3282b8,
        footer: {
            text: `Kaczor Addons - Players Online - Dream • ${timestamp} • Łącznie: ${players.length} graczy`
        },
        thumbnail: {
...
async function sendAllTitansToDiscord() {
    ...
    const embed = {
        title: `🏰 Wszyscy gracze online - Dream`,
        description: `Pełna lista graczy online pogrupowanych według tytanów`,
        color: 0x3282b8,
        fields: fields,
        footer: {
            text: `Kaczor Addons - Players Online - Dream • ${timestamp} • Łącznie: ${currentPlayersData.length} graczy`
        }
    };
            ...
            box.innerHTML = `
                <div id="online-box-header">
                    <div id="online-box-title">
                        <span class="emoji">☀️</span>Online: Dream
